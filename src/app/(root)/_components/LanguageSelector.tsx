...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  const handleLanguageSelect = (langId: string) => {
    if (!hasAccess && langId !== "java" && langId !== "python") return;
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      rounded-lg transition-all 
       ...
       ${!hasAccess && language !== "java" && language !== "python" ? "opacity-50 cursor-not-allowed" : ""}`}
      >
        {/* Decoration */}
        <div
        ...
        <motion.div
          ...
          className="size-6 rounded-md bg-gray-800/50 p-0.5"
        >
          <Image
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden">
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                const isLocked = !hasAccess && lang.id !== "java" && lang.id !== "python";
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        whileHover={{ scale: 1.15 }}
                        className={`
                         relative size-8 rounded-lg p-1.5
